    ...
    <div className="flex w-full flex-col gap-1">
      ...
      <div className="relative w-full">
        <input
          ...
          className={cn(
            'w-full rounded-lg border border-devflow-border bg-white px-3 py-2 pr-10 text-input text-devflow-text outline-none transition-colors placeholder:text-devflow-text-muted focus:border-devflow-primary focus:ring-2 focus:ring-devflow-primary/20',
            className,
          )}
          {...props}
        />
        <button
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 text-devflow-text-muted"
